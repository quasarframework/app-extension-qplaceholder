<template>
  <q-list>
    <q-item clickable to="/docs">
      ...
      <q-item-section>
        <q-item-label>QPlaceholder docs</q-item-label>
    ...
    <q-item clickable to="/examples">
      ...
      <q-item-section>
        <q-item-label>QPlaceholder examples</q-item-label>
        <q-item-label caption>Examples of how to do it</q-item-label>
      </q-item-section>
    </q-item>
    <q-separator />
    <q-item clickable tag="a" target="_blank" href="https://github.com/hawkeye64/app-extension-qplaceholder">
      <q-item-section avatar>
        <q-icon name="extension" />
      </q-item-section>
      <q-item-section>
        <q-item-label>QPlaceholder home</q-item-label>
        <q-item-label caption>qplaceholder</q-item-label>
      </q-item-section>
    </q-item>
